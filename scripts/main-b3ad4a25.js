...
!function (root, factory) {
  ...
  return VisSense.VisState = {
    ...
    return me._started || (me._update = debounce(function () {
      monitor.update();
    }, me._config.debounce), VisibilityApi && addEventListener(VisibilityApi[1], me._update), addEventListener('scroll', me._update), addEventListener('resize', me._update), me._update(), me._started = !0), this._started;
  }, VisMon.Strategy.EventStrategy.prototype.stop = function () {
    var me = this;
    return me._started ? (removeEventListener('resize', me._update), removeEventListener('scroll', me._update), VisibilityApi && removeEventListener(VisibilityApi[1], me._update), me._started = !1, !0) : !1;
...
/*! { "name": "vissense-plugin-percentage-time-test", "version": "0.2.1", "copyright": "(c) 2015 tbk" } */
;
(function (root, factory) {
  'use strict';
  ...
  angular.module('vissensePlayground').directive('tbkVissenseReportPercentiles', [function () {
    ...
    function ($window, $document, $scope) {
      $scope.scrollToElement = function (elementId) {
        $('html, body').animate({ scrollTop: jQuery('#' + elementId).offset().top }, 500);  //$window.scrollTo(0, top);
      };
